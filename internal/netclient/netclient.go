// Package netclient builds HTTP clients and proxy resolvers that share Corvus's
...
// NewHTTPClient returns an HTTP client with Corvus proxy settings applied.
