...
var English = Messages{
	...
	ChatStatusPlanApprovalCompact:  "Enter select · Esc back",
	...
	ChatStatusToolApprovalCompact:  "n/Esc deny",
	...
	CheatsheetCloseHint:            "Esc closes",
	CheatsheetStatusLabel:          "keyboard shortcuts · Esc closes",
	CheatsheetSectionNavigation:    "Navigation",
	CheatsheetSectionModes:         "Modes",
	CheatsheetSectionTranscript:    "Transcript",
	CheatsheetSectionDiscover:      "Discoverability",
	CheatsheetSectionSession:       "Session",
	CheatsheetHintEnter:            "send message",
	CheatsheetHintEsc:              "cancel turn / clear draft / back",
	CheatsheetHintPageScroll:       "scroll transcript",
	CheatsheetHintHomeEnd:          "jump transcript top / bottom",
	CheatsheetHintShiftTab:         "cycle ask / auto / plan",
	CheatsheetHintCtrlY:            "toggle YOLO (skip tool approvals)",
	CheatsheetHintCtrlB:            "expand shell / tool output",
	CheatsheetHintCtrlO:            "toggle verbose reasoning",
	CheatsheetHintQuestion:         "this cheatsheet (empty input)",
	CheatsheetHintCtrlP:            "command palette",
	CheatsheetHintSlash:            "slash commands",
	CheatsheetHintStatus:           "session details (balance, cache, git)",
	CheatsheetHintResume:           "resume a saved session",
	CheatsheetHintNew:              "start a new session",
	CheatsheetHintClear:            "clear transcript",
	CheatsheetHintHelp:             "list slash commands",
	...
	SlashHelp:          "commands: /compact · /new · /clear · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model (switch model) · /effort · /theme · /language · /mcp · /skills · /plugins · /hooks · /paste-image · /memory · /goal · /remember · /quit · /help · plus skills (/init, /explore, …)",
	...
	CmdRuntimePolicy:    "inspect or set runtime policy axes",
	...
	RuntimePolicyHeader:            "runtime policy",
	RuntimePolicyListHint:          "set with /runtime-policy guidance|completion|exposure <value>",
	RuntimePolicyUsage:             "usage: /runtime-policy [guidance inherit|auto|off|light|structured | completion inherit|auto|standard|verified | exposure inherit|auto|eager|deferred]",
	RuntimePolicySwitchUnavailable: "runtime-policy switching is unavailable in this session",
	RuntimePolicySwitchBusy:        "finish or cancel active work before changing runtime policy",
	RuntimePolicyAlreadyOnFmt:      "runtime policy %s is already %s",
	RuntimePolicySwitchingFmt:      "setting runtime policy %s to %s…",
	RuntimePolicySwitchedFmt:       "runtime policy %s set to %s (conversation carried over; prompt cache resets)",
