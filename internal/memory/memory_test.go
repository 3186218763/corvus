...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/CORVUS.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "CORVUS.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "CORVUS.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "CORVUS.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "CORVUS.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportResolutionRejectsEscapes(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "CORVUS.md"), "Top\n@/abs/path.md\n@~/secret.md\n@../secret.md\nBottom")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "CORVUS.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "CORVUS.md"), "@cycle1.md")
