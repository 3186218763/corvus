...
func TestManagedConfigWriteApprovalIsFreshHuman(t *testing.T) {
	...
	subject := "write Corvus config: /home/u/.corvus/config.toml"
	...
	if !a.preApprovedForDecision(ManagedConfigWriteApprovalTool, "write Corvus config: /other/path", nil, true) {
