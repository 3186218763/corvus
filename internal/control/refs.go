...
const (
	...
	refImage                   // a local image attachment: @.corvus/attachments/<file>
)
...
func isAttachmentRef(token string) bool {
	return strings.HasPrefix(filepath.ToSlash(token), ".corvus/attachments/")
}
...
// text rather than a Corvus slash command.
