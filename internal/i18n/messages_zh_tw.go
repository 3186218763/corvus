...
var ChineseTraditional = Messages{
	...
	ChatStatusPlanApprovalCompact:  "Enter 選擇 · Esc 返回",
	...
	ChatStatusToolApprovalCompact:  "n/Esc 拒絕",
	...
	CheatsheetTitle:                "鍵盤快捷鍵",
	CheatsheetCloseHint:            "Esc 關閉",
	CheatsheetStatusLabel:          "鍵盤快捷鍵 · Esc 關閉",
	CheatsheetSectionNavigation:    "導覽 / 輸入",
	CheatsheetSectionModes:         "模式",
	CheatsheetSectionTranscript:    "對話紀錄",
	CheatsheetSectionDiscover:      "探索",
	CheatsheetSectionSession:       "工作階段",
	CheatsheetHintEnter:            "傳送訊息",
	CheatsheetHintEsc:              "取消本輪 / 清空草稿 / 返回",
	CheatsheetHintPageScroll:       "捲動對話紀錄",
	CheatsheetHintHomeEnd:          "跳到對話頂部 / 底部",
	CheatsheetHintShiftTab:         "切換 詢問 / 自動 / 計畫",
	CheatsheetHintCtrlY:            "切換 YOLO（略過工具核准）",
	CheatsheetHintCtrlB:            "展開 shell / 工具輸出",
	CheatsheetHintCtrlO:            "切換詳細推理",
	CheatsheetHintQuestion:         "本快捷鍵表（輸入為空時）",
	CheatsheetHintCtrlP:            "命令面板",
	CheatsheetHintSlash:            "斜線命令",
	CheatsheetHintStatus:           "工作階段詳情（餘額、快取、git）",
	CheatsheetHintResume:           "恢復已儲存工作階段",
	CheatsheetHintNew:              "新建工作階段",
	CheatsheetHintClear:            "清空對話紀錄",
	CheatsheetHintHelp:             "列出斜線命令",
	...
	SlashHelp:          "命令：/compact · /new（/clear）· /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model（切換模型）· /effort · /theme · /language · /mcp · /skills · /plugins · /hooks · /paste-image · /memory · /remember · /quit · /help · 以及 skills（/init、/explore …）",
	...
	CompHintSlash:                "↑/↓ 移動 · Enter 執行 · Tab 補全 · Esc 關閉",
	...
	RuntimePolicyHeader:            "執行時策略",
	RuntimePolicyListHint:          "用 /runtime-policy guidance|completion|exposure <值> 設定",
	...
	RuntimePolicySwitchUnavailable: "目前工作階段無法切換執行時策略",
	RuntimePolicySwitchBusy:        "請先完成或取消目前工作再改執行時策略",
	RuntimePolicyAlreadyOnFmt:      "執行時策略 %s 已經是 %s",
	RuntimePolicySwitchingFmt:      "正在將執行時策略 %s 設為 %s…",
	RuntimePolicySwitchedFmt:       "執行時策略 %s 已設為 %s（保留目前對話，但提示詞快取會重新計算）",
	RewindNone:                     "暫無可回滾的內容",
