...
// IsolateUserState redirects default user-scoped Corvus paths to a disposable
...
func IsolateUserState() (func(), error) {
	...
	home, err := os.MkdirTemp(originalHome, ".corvus-test-home-*")
	if err != nil && originalHome != "" {
		home, err = os.MkdirTemp("", "corvus-test-home-*")
	}
	if err != nil {
